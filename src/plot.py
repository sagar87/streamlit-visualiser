...
def plain_img_box(thumbnail, xmin, xmax, ymin, ymax, xdim, ydim):
    ...
    ax.text(xmin-100, ydim / 100 * 5, s=f'{xmin}', fontsize=16, color='k', va='bottom', ha='right')
    ax.text(xmax+100, ydim-(ydim / 100 * 5), s=f'{xmax}', fontsize=16, color='k', va='top', ha='left')
    ax.text(xdim / 100 * 5, ymax+100, s=f'{ymax}', fontsize=16, color='k', va='bottom', ha='left')
    ax.text(xdim-(xmax / 100 * 5), ymin-200, s=f'{ymin}', fontsize=16, color='k', va='top', ha='right')
